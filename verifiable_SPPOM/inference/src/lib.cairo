...
let node_relu1_relu_output_0 = NNTrait::relu(@node_fc1_gemm_output_0);
let node_fc2_gemm_output_0 = NNTrait::gemm(node_relu1_relu_output_0, get_node_fc2_weight(), Option::Some(get_node_fc2_bias()), Option::Some(FP16x16 { mag: 65536, sign: false }), Option::Some(FP16x16 { mag: 65536, sign: false }), false, true);
let node_relu2_relu_output_0 = NNTrait::relu(@node_fc2_gemm_output_0);
let node_output = NNTrait::gemm(node_relu2_relu_output_0, get_node_fc3_weight(), Option::Some(get_node_fc3_bias()), Option::Some(FP16x16 { mag: 65536, sign: false }), Option::Some(FP16x16 { mag: 65536, sign: false }), false, true);
